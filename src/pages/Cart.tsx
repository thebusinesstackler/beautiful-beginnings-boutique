    ...
    <div className="min-h-screen bg-gradient-to-br from-cream via-pearl to-blush/20">
      ...
      <div className="max-w-screen-xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 md:py-12">
        ...
        <div className="mb-6 md:mb-12">
          <Link
            to="/"
            className="inline-flex items-center text-xs sm:text-sm font-medium text-charcoal/60 hover:text-charcoal mb-4 md:mb-6 transition-colors"
          >
            ...
            <div className="lg:col-span-1 order-first lg:order-last">
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-sage/10 p-6 md:p-8 lg:sticky lg:top-8">
                ...
                <div className="space-y-3 md:space-y-4">
                  <Link to="/checkout">
                    <Button 
                      className="w-full text-white text-lg sm:text-xl font-bold py-4 sm:py-6 px-6 sm:px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                      style={{
