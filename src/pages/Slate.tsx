        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center">
              ...
              <p className="text-lg" style={{ color: '#A89B84' }}>Loading elegant slate keepsakes...</p>
            </div>
          </div>
        </div>
        <Footer />
      ...
      <section className="relative py-20 overflow-hidden" style={{ backgroundColor: '#FAF5EF' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="flex items-center space-x-2 text-sm mb-8" style={{ color: '#A89B84' }}>
            ...
            <span>/</span>
            <span style={{ color: '#5B4C37' }}>Slate Keepsakes</span>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="inline-flex items-center px-6 py-3 rounded-full text-sm font-semibold mb-6" style={{ backgroundColor: '#F6DADA', color: '#7A7047' }}>
              ...
              Natural Stone Memories
            </div>
            
            <h1 className="text-4xl md:text-6xl font-playfair font-bold mb-6 leading-tight">
              <span style={{ color: '#5B4C37' }}>Slate Photo Keepsakes</span>
              <br />
              <span className="bg-gradient-to-r from-[#E28F84] to-[#F4A79B] bg-clip-text text-transparent">Timeless Elegance</span>
            </h1>
            
            <p className="text-xl mb-8 max-w-3xl mx-auto leading-relaxed" style={{ color: '#A89B84' }}>
              Preserve your most treasured memories on elegant slate pieces that blend natural beauty with personal meaning. 
              Each handcrafted slate keepsake transforms your favorite photos into sophisticated home décor that tells your story 
              with rustic charm and timeless appeal.
            </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg max-w-4xl mx-auto mb-12" style={{ borderColor: '#F6DADA', borderWidth: '1px' }}>
              ...
              <p className="mb-6 max-w-2xl mx-auto" style={{ color: '#A89B84' }}>
                ...
                Perfect for home décor, memorial displays, or meaningful gifts that last forever.
              </p>
              <Button 
          ...
          <div className="space-y-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold mb-4" style={{ color: '#5B4C37' }}>
                Our Elegant Slate Collection
              </h2>
              <p className="text-lg max-w-2xl mx-auto" style={{ color: '#A89B84' }}>
                Each slate keepsake is meticulously crafted to preserve your memories with natural beauty and sophistication.
              </p>
            </div>
          ...
          <div className="text-center py-20">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-playfair font-bold mb-4" style={{ color: '#5B4C37' }}>
                New Slate Keepsakes Coming Soon
              </h3>
              <p className="text-lg mb-6" style={{ color: '#A89B84' }}>
                We're crafting beautiful new slate designs just for you. Check back soon for our latest collection!
              </p>
              <Link to="/">
                <Button 
