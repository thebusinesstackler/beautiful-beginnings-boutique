        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center">
              ...
              <p className="text-lg" style={{ color: '#A89B84' }}>Loading beautiful ornaments...</p>
            </div>
          </div>
        </div>
        <Footer />
          ...
          <div className="space-y-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold mb-4" style={{ color: '#5B4C37' }}>
                Our Beautiful Ornament Collection
              </h2>
              <p className="text-lg max-w-2xl mx-auto" style={{ color: '#A89B84' }}>
                Each ornament is carefully crafted to preserve your most treasured memories in stunning detail.
              </p>
            </div>
          ...
          <div className="text-center py-20">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-lg mb-6" style={{ color: '#A89B84' }}>
                We're crafting beautiful new ornament designs just for you. Check back soon for our latest collection!
              </p>
              <Link to="/">
                <Button 
