        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center">
              ...
              <p className="text-lg" style={{ color: '#A89B84' }}>Loading wood sublimation products...</p>
            </div>
          </div>
        </div>
        <Footer />
      ...
      <section className="relative py-20 overflow-hidden" style={{ backgroundColor: '#FAF5EF' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="flex items-center space-x-2 text-sm mb-8" style={{ color: '#A89B84' }}>
            ...
            <span>/</span>
            <span style={{ color: '#5B4C37' }}>Wood Sublimation</span>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="inline-flex items-center px-6 py-3 rounded-full text-sm font-semibold mb-6" style={{ backgroundColor: '#F6DADA', color: '#7A7047' }}>
              ...
              Natural Wood Artistry
            </div>
            
            <h1 className="text-4xl md:text-6xl font-playfair font-bold mb-6 leading-tight">
              <span style={{ color: '#5B4C37' }}>Wood Photo Sublimation</span>
              <br />
              <span className="bg-gradient-to-r from-[#E28F84] to-[#F4A79B] bg-clip-text text-transparent">Rustic Beauty Preserved</span>
            </h1>
            
            <p className="text-xl mb-8 max-w-3xl mx-auto leading-relaxed" style={{ color: '#A89B84' }}>
              Transform your favorite memories into stunning wood art pieces that blend natural warmth with personal meaning. 
              Our sublimation process creates vibrant, long-lasting images on beautiful wood surfaces, 
              perfect for home décor that tells your story with rustic elegance.
            </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg max-w-4xl mx-auto mb-12" style={{ borderColor: '#F6DADA', borderWidth: '1px' }}>
              ...
              <h2 className="text-2xl font-playfair font-semibold mb-3" style={{ color: '#5B4C37' }}>
                Create Your Wood Art Piece
              </h2>
              <p className="mb-6 max-w-2xl mx-auto" style={{ color: '#A89B84' }}>
                Bring your photos to life on beautiful natural wood surfaces. Perfect for rustic home décor, 
                meaningful gifts, or creating unique art pieces that showcase your most treasured memories.
              </p>
              <Button 
          ...
          <div className="space-y-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold mb-4" style={{ color: '#5B4C37' }}>
                Our Beautiful Wood Collection
              </h2>
              <p className="text-lg max-w-2xl mx-auto" style={{ color: '#A89B84' }}>
                Each wood piece is carefully selected and crafted to showcase your memories with natural beauty and warmth.
              </p>
            </div>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-3">
                      <Link to={`/products/wood-sublimation/${product.id}`} className="block">
                        <Button 
                          size="sm"
                          variant="outline" 
            ...
            <div className="max-w-md mx-auto">
              <div className="mb-6">
                <div className="w-24 h-24 mx-auto rounded-full flex items-center justify-center" style={{ backgroundColor: '#F6DADA' }}>
                  <Sparkles className="h-12 w-12" style={{ color: '#E28F84' }} />
                </div>
              </div>
              <h3 className="text-2xl font-playfair font-bold mb-4" style={{ color: '#5B4C37' }}>
                New Wood Products Coming Soon
              </h3>
              <p className="text-lg mb-6" style={{ color: '#A89B84' }}>
                We're crafting beautiful new wood sublimation pieces just for you. Check back soon for our latest collection!
              </p>
              <Link to="/">
                <Button 
