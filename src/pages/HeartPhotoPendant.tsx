...
const HeartPhotoPendant = () => {
  ...
  const product = {
    ...
    benefits: ["Romantic heart shape design", "Water-resistant coating", "Ships within 3 business days", "Lifetime memory preservation", "Perfect for anniversary gifts"]
  };

  const relatedProducts = [
    { id: 1, name: "Photo Memory Necklace", price: 15.00, image: "https://img.kwcdn.com/product/open/2fe48b660cda4288b8989a4cce3e7ccf-goods.jpeg?imageView2/2/w/800/q/70/format/webp" },
  ...
  const reviews = [
    { name: "Emma T.", rating: 5, comment: "The heart shape is perfect! My husband loves wearing our wedding photo close to his heart.", date: "1 week ago" },
    { name: "David K.", rating: 5, comment: "Beautiful craftsmanship. The photo quality exceeded my expectations.", date: "2 weeks ago" },
    { name: "Lisa P.", rating: 4, comment: "Lovely pendant, though the chain could be a bit longer. Overall very happy!", date: "1 month ago" }
  ];
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-sm" style={{ color: '#a48f4b' }}>(28 reviews)</span>
              </div>
        ...
        <div className="mt-20 space-y-16">
          ...
          <section className="bg-white p-8 rounded-xl shadow-sm">
            <h2 className="text-2xl font-playfair font-bold mb-6" style={{ color: '#2d3436' }}>
              Why Choose Our Heart Photo Pendant?
            </h2>
