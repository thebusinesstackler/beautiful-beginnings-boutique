  ...
  const fetchProducts = async () => {
    try {
      const { data, error } = await supabase
        ...
        .eq('is_active', true)
        .in('category', ['Necklaces', 'Ornaments', 'Snow Globes'])
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center">
              ...
              <p className="text-lg" style={{ color: '#A89B84' }}>Loading anniversary gift ideas...</p>
            </div>
          </div>
        </div>
        <Footer />
      ...
      <section className="relative py-20 overflow-hidden" style={{ backgroundColor: '#FAF5EF' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex items-center space-x-2 text-sm mb-8" style={{ color: '#A89B84' }}>
            ...
            <span>/</span>
            <span style={{ color: '#5B4C37' }}>Anniversary Gifts</span>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg max-w-4xl mx-auto mb-12" style={{ borderColor: '#F6DADA', borderWidth: '1px' }}>
              <div className="flex items-center justify-center mb-4">
                ...
                <Gift className="h-6 w-6" style={{ color: '#7A7047' }} />
              </div>
              <h2 className="text-2xl font-playfair font-semibold mb-3" style={{ color: '#5B4C37' }}>
                Make Every Anniversary Unforgettable
              </h2>
              <p className="mb-6 max-w-2xl mx-auto" style={{ color: '#A89B84' }}>
                Whether it's your first anniversary or your golden jubilee, our personalized gifts help you celebrate 
                the beautiful moments you've shared and create new memories to treasure forever.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="max-w-md mx-auto">
              <div className="mb-6">
                <div className="w-24 h-24 mx-auto rounded-full flex items-center justify-center" style={{ backgroundColor: '#F6DADA' }}>
                  <Heart className="h-12 w-12" style={{ color: '#E28F84' }} />
                </div>
              </div>
